...
Setting everything up for the R environment.
```{r setup}
## Libraries
...
#setwd("C:/Users/jbehr/OneDrive - Duke University/Documents/5. R/2.-Ellerbe_Flat-River") # Only needed if outside RMarkdown
```
